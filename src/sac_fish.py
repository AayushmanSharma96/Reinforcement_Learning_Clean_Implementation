...
ENV_NAME = 'FishEnv-v0'
k = 10
csv_file = 'sac_fish_output_v0_buffer10_7_10M_'+str(k)+'.csv' #csv file to store training progress
exp_name = 'sac_fish_v0_buffer10_7_10M_'+str(k)
run_name = 'sac'
...
def make_env(env_id, render_bool):
    ...
    if render_bool:
        ...
        env = gym.make('FishEnv-v0',render_mode = "human")
    else:
        env = gym.make('FishEnv-v0')
