...
ENV_NAME = 'Swimmer-v5'
k = 5
csv_file = 'sac_swimmer_output_v5_buffer10_7_5M_'+str(k)+'.csv' #csv file to store training progress
exp_name = 'sac_swimmer_v5_buffer10_7_5M_'+str(k)
run_name = 'sac'
...
def reward_function(observation, action, next_obs):
    ...
    xy_position_before = obs[0:2].copy()
    xy_position_after = next_obs[0:2].copy()
...
if __name__ == "__main__":
    ...
    buffer_size = int(1e7)
    batch_size = 256
    total_timesteps = 5000000 #default = 1000000
    ...
    for global_step in range(total_timesteps):
        ...
        if abs(next_obs[0])>= 100 or episode_t == episode_length:
            print('resetting')
            episode_count += 1
